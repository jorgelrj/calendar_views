...
class _DaysPageControllerInitialisationDialogState
  ...
  Future<void> _changeFirstDayOfInitialPage() async {
    DateTime firstDayOfInitialPage = await showDatePicker(
      context: context,
    ...
    if (firstDayOfInitialPage == null) {
      return;
    }

    setState(() {
      _firstDayOfInitialPage = firstDayOfInitialPage;
    });
  }
